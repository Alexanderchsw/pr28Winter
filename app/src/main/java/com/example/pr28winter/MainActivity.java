package com.example.pr28winter;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView dogImageView = findViewById(R.id.vidra);
        Animation dogAnimation = AnimationUtils.loadAnimation(this,R.anim.vidra);
        dogImageView.startAnimation(dogAnimation);
    }
}